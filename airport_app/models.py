...
class Usuario(AbstractUser):
    ...
    fecha_nacimiento = models.DateTimeField(auto_now=False, null=True)
    token = models.CharField(max_length=100, default='', null=True, blank=True) # se guarda inf cuando el usuario se logea
...
class Piloto(models.Model):
    ...
    horas_vuelo_piloto = models.BigIntegerField()
    def __str__(self):
