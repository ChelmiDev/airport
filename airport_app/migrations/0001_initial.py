    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='airport_app.avion')),
                ('piloto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='airport_app.piloto')),
            ],
        ),
        migrations.CreateModel(
            name='Itinerario',
            fields=[
                ...
                ('numero_vuelo', models.CharField(max_length=20, unique=True)),
                ('codigo_tripulante', models.CharField(max_length=20, unique=True)),
                ('tripulacion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='airport_app.tripulacion')),
                ('vuelo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='airport_app.vuelo')),
            ],
        ),
    ]
